...
const CategoryFoodCard = (props) => {
  ...
  return (
    <div onClick={()=>(navigate(`/recipe/${props.meal.idMeal}`))} className="savory-card p-4 rounded-[3rem] group cursor-pointer">
        ...
        <h3 className="text-xl font-bold px-4 pb-6 outfit italic">{props.meal.strMeal}</h3>
    </div>
  )
}
