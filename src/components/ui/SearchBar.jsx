...
const SearchBar = () => {
  return (
      <div>
          <div class=" items-center hidden [@media(min-width:940px)]:flex border pl-4 gap-2 bg-white border-gray-500/30 h-[46px] rounded-full overflow-hidden max-w-md w-full">
